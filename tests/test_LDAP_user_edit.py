...
from wagtail_patches.views.users import edit
from ..forms import LDAPUserEditForm
...
class TestLDAPUserEdit(SecureClientMixin, TestCase, AssertHTMLMixin, MultitenantSiteTestingMixin):
    ...
    def test_superusers_can_be_ungrouped(self):
        ...
        with Replacer() as r:
            r.replace('custom_auth.forms.search_ldap_for_user', self.ldap_search_dummy)
    ...
    def test_edit_LDAP_user_successfully(self):
        ...
        with Replacer() as r:
            ...
            self.assertTrue('<Group: wagtail.flint.caltech.edu Admins>' in str(capture))
    ...
    def test_admin_user_sees_remove_user_button(self):
        ...
        response = self.client.get(
            ...
            HTTP_HOST="wagtail.flint.caltech.edu"
        )
        self.assertEqual(response.status_code, 200)
